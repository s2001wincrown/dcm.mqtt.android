...
public class Persistence extends SQLiteOpenHelper implements BaseColumns {
    ...
    //Web Api URI for Data Post
    public static final String COLUMN_WEBAPIURI = "webApiURI";
    ...
    private static final String SQL_CREATE_ENTRIES =
            ...
            "CREATE TABLE " + TABLE_CONNECTIONS + " (" +
                    ...
                    COLUMN_WEBAPIURI + TEXT_TYPE + COMMA_SEP +
    ...
    private ContentValues getValues(Connection connection){
        ...
        values.put(COLUMN_WEBAPIURI, connection.getWebApiURI());
    ...
    public List<Connection> restoreConnections(Context context) throws PersistenceException {
        ...
        for (int i = 0; i < c.getCount(); i++) {
            ...
            String webApiURI = c.getString(c.getColumnIndexOrThrow(COLUMN_WEBAPIURI));
            ...
            connection = Connection.createConnection(clientHandle, clientID, host, port, context, ssl, webApiURI);
