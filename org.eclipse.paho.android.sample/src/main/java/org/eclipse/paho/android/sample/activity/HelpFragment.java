...
public class HelpFragment extends Fragment {
    ...
    private static final String FEEDBACK_EMAIL = "johnlee@s2001.com";
    private static final String FEEDBACK_SUBJECT = "DCM MQTT Android Feedback";
    ...
    private static final String DCM_WEBSITE = "http://www.dcmplayer.com/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        websiteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(DCM_WEBSITE));
