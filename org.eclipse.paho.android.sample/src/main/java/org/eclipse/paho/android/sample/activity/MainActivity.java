...
public class MainActivity extends AppCompatActivity implements FragmentDrawer.FragmentDrawerListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(connectionMap.size() > 0){
            Map<String, Connection> connections = Connections.getInstance(this)
                    .getConnections();
            connect(connections.get(connectionMap.get(0)));
        }
    }
    ...
    public void updateAndConnect(ConnectionModel model){
        ...
        try {
            ...
            connection.updateConnection(model.getClientId(), model.getServerHostName(), model.getServerPort(), model.isTlsConnection(), model.getWebApiURI());
    ...
    public void persistAndConnect(ConnectionModel model){
        ...
        Connection connection = Connection.createConnection(model.getClientHandle(),model.getClientId(),model.getServerHostName()
                ,model.getServerPort(),this,model.isTlsConnection(), model.getWebApiURI());
